...
const PHOTOS = {
  rohit: { src: 'rohit.png', style: { left: -5.28, top: 7.51, width: 249.42, height: 311.77 } },
  bhavika: { src: 'bhavika.png', style: { left: -9.27, top: -3.68, width: 255.97, height: 319.97 } },
}
...
export default function TeamCard({ person, delay = 0 }) {
  ...
  return (
    <article className="tcard" ref={ref} data-reveal style={{ '--delay': `${delay}s` }}>
      <div className="tcard__bg"><img src={img('team-bg.png')} alt="" /></div>
